...
//! Challenge continues at 10-Asychronus JS file.
...
const createImage = function (imgPath) {
  return new Promise(function (resolve, reject) {
    ...
    //? load event listener. call func when img is loaded!
    //? RESOLVE
...
//     return createImage('./img/img1.jpg');
//   })
//   .then(img => {
//     currentImg = img;
...
loadAll(['./img/img1.jpg', './img/img2.jpg', './img/img3.jpg']);
